...
multiple_student_subjects = [
    (92400133046, 'Dineshbhai Shetty', 'PWP', 97),
    (92400133046, 'Dineshbhai Shetty', 'ICE', 98),
    (92400133046, 'Dineshbhai Shetty', 'DMGT', 94),
    (92400133046, 'Dineshbhai Shetty', 'DSC', 89),
    (92400133046, 'Dineshbhai Shetty', 'SS', 88),
    (92400133046, 'Dineshbhai Shetty', 'SPDT', 87)
]
cursor.executemany('''
...
cursor.execute ('''
    ...
    SET Mark = 98 
    WHERE Enrollment = 92400133046 AND Subject = 'ICE'
''')
conn.commit ()
...
cursor.execute ('''
    ...
    WHERE Enrollment = 92400133046 AND Subject = 'PWP'
''')
conn.commit ()
